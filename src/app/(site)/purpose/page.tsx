  ...
  return (
    <div className="p-6 flex justify-center items-start w-[100svw] h-[100svh] bg-[#171717]">
      ...
      <div className="w-full max-w-[100%] flex-col auth flex items-center justify-center">
        <p
          className={`md:inline-flex hidden text-white ${reenie.className} text-[35px] mt-10 mb-12 flex`}
        >
          Journeylog
          <Image
            src={LOGO}
            alt=""
            className="mt-[-25px] w-[40px] ml-3"
          />
        </p>
        <div className="w-[600px] max-w-[95%] text-center mt-20 md:mt-0">
          <h1 className="md:text-[65px] text-[40px] leading-[40px] font-bold mb-5 md:mb-10 text-[white]">Our purpose</h1>
          ...
          <p className="text-[16px] md:text-[24px] leading-[25px] md:leading-[35px] mb-28 text-[#909090]">
