...
const Purpose = () => {
  return (
    <div className="p-6 flex flex-col w-[100svw] h-[100svh] bg-[#171717]">
      <header className="flex w-[850px] rounded-2xl m-auto justify-between max-w-[95%] mt-8 bg-[#1E1E1E] border-1 border-[#303030] py-4 px-2 md:px-2 mb-10 md:mb-20">
        <Image
          src={LOGO}
          width={150}
          alt="Logo"
      ...
      <div className="w-full max-w-[100%] flex-col auth flex items-center justify-center">
        <div className="w-[600px] max-w-[95%] md:text-left md:mt-6 text-[#909090]">
          ...
          <p className="text-[18px] md:text-[24px]  md:leading-[40px] mb-7">
            ...
            consistent choices. We believe that the real power comes from you
            showing up for yourself every single day.
          </p>
          <br />
          <p className="text-[18px] md:text-[24px] md:leading-[40px] mb-7">
            Self-control isn’t just something you’re born with, it’s shaped by
            your environment too. By making small tweaks, like setting up a
            routine or tracking progress, you create a space where healthy
            choices come naturally, breaking out of autopilot and overcoming the
            inertia of sticking to what’s comfortable.
          </p>
          <br />
          ...
          <p className="text-[18px] md:text-[24px] md:leading-[40px] mb-12">
            We are here to remind you that meaningful change comes from the
            small, intentional steps you take every day. Growth isn’t about
